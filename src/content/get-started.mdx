...
You can read more details on each rule in the [register section](/docs#register).
...
React Hook Form has made it easy to integrate with external UI component libraries. If the component doesn't expose the input's `ref`, then you should use the [Controller](/docs#Controller) component, which will take care of the registration process.
