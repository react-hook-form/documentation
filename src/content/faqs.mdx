...
| **Rendering**      | minimum re-render and optimize computation                                                                                                                                                                   | re-render according to local state changes (As you type in the input.) | re-render according to state management lib (Redux) changes (As you type in the input.) |
