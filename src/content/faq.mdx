...
```javascript codesandbox="https://codesandbox.io/s/react-hook-form-faq-toggle-fields-3htr6" copy
import React from "react"
import { useForm } from "react-hook-form"
...
```javascript copy codesandbox="https://codesandbox.io/s/react-hook-form-controlled-input-forked-rl2v1"
import React, { useEffect } from "react"
import { useForm } from "react-hook-form"
