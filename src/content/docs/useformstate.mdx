---
title: useFormState
description: Subscribe to form state with isolated component re-renders.
metaDescription: Subscribe to specific form state properties and isolate re-renders at the component level for better performance in large React Hook Forms.
sidebar: apiLinks
---
