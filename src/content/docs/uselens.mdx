---
title: useLens
description: Scope form context to a nested field path.
metaDescription: Type-safe functional lenses that scope form context to a nested field path, reducing boilerplate in deeply nested React Hook Forms.
sidebar: apiLinks
---
