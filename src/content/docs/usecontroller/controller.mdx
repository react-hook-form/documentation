...
| `exact`            | <TypeText>boolean = true</TypeText>                                |          | <Since version="7.67.0" /> This prop will enable an exact match for input name subscriptions, default to true.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `formState`                            | `isValid`            | <TypeText>boolean</TypeText>                | Set to `true` if the form doesn't have any errors.<br/><br/>`setError` has no effect on `isValid` formState; `isValid` will always be derived from the entire form validation result.                                                                                                                                                                                                                                                                                                                                                                                           |
