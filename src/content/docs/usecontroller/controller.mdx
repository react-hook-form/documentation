...
| `formState`                            | `defaultValues`      | <TypeText>object</TypeText>                 | The value that was set in [useForm](/docs/useform)'s `defaultValues` or updated `defaultValues` via the [reset](/docs/useform/reset) API.                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `formState`                            | `validatingFields`   | <TypeText>object</TypeText>                 | Captures fields that are undergoing asynchronous validation.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
