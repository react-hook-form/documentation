---
title: useWatch
description: Subscribe to input changes with isolated component re-renders.
metaDescription: Subscribe to input value changes with isolated component-level re-renders, offering better performance than watch for large React Hook Forms.
sidebar: apiLinks
---
...
| `exact`        | <TypeText>boolean = false</TypeText>                 | Enable exact name matching. When `false` (default), a subscription fires when the subscribed name is a prefix of the changed field name, or vice versa (for example, subscribing to `"users"` receives updates for `"users.0.name"`).                                                                                                                                                                                                                                                                                                                                    |
