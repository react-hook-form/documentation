---
title: getValues
description: Read current form values without subscribing to re-renders.
metaDescription: Read current form values without subscribing to re-renders. Retrieve a single field, multiple fields, or the entire form data object.
sidebar: apiLinks
---
