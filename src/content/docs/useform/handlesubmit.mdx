---
title: handleSubmit
description: Validate inputs and invoke your submit callback.
metaDescription: Validate form inputs and invoke your submit callback with typed form data, or pass errors to an error handler on validation failure.
sidebar: apiLinks
---
