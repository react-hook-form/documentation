---
title: unregister
description: Remove a registered input from the form.
metaDescription: Remove a registered input from React Hook Form, optionally preserving its value, error, dirty, or touched state on unmount.
sidebar: apiLinks
---
