---
title: resetField
description: Reset a single field's value and state independently.
metaDescription: Reset a single field's value and state — errors, dirty, and touched — independently without resetting the entire React Hook Form.
sidebar: apiLinks
---
