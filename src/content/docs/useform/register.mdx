...
| `min`       | <TypeText>string \| number</TypeText> | _optional_. Present when the `min` rule is set, and forwarded as a native attribute when [`progressive`](/docs/useform/form) is `true`. |
| `max`       | <TypeText>string \| number</TypeText> | _optional_. Present when the `max` rule is set, and forwarded as a native attribute when `progressive` is `true`.                       |
| `maxLength` | <TypeText>number</TypeText>           | _optional_. Present when the `maxLength` rule is set, and forwarded as a native attribute when `progressive` is `true`.                 |
| `minLength` | <TypeText>number</TypeText>           | _optional_. Present when the `minLength` rule is set, and forwarded as a native attribute when `progressive` is `true`.                 |
| `pattern`   | <TypeText>string</TypeText>           | _optional_. Present when the `pattern` rule is set, and forwarded as a native attribute when `progressive` is `true`.                   |
| `required`  | <TypeText>boolean</TypeText>          | _optional_. Present when the `required` rule is set, and forwarded as a native attribute when `progressive` is `true`.                  |
| `disabled`  | <TypeText>boolean</TypeText>          | _optional_. Present when the `disabled` option is set.                                                                                  |
