---
title: register
description: Register inputs for validation, tracking, and submission.
metaDescription: Register an input with React Hook Form to enable validation, value tracking, and form submission. Supports text, checkbox, select, and more.
sidebar: apiLinks
---
