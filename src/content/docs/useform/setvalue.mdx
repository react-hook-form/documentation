...
|                                          | `delayError`<br/><TypeText>number</TypeText>      | Opt-in option that delays the display of the resulting validation error by the specified number of milliseconds. Only takes effect when `shouldValidate` is set to `true`.                                                                                                                                                                                                                                  |
