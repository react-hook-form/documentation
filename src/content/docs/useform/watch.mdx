---
title: watch
description: Subscribe to input value changes and trigger re-renders.
metaDescription: Subscribe to one or more input value changes and trigger re-renders. Useful for conditional form logic and dependent field calculations.
sidebar: apiLinks
---
