---
title: reset
description: Reset the form to its default values and clear state.
metaDescription: Reset the entire form to default values, clearing all errors, dirty fields, and touched state in React Hook Form.
sidebar: apiLinks
---
