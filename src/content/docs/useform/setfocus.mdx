---
title: setFocus
description: Programmatically focus a registered input field.
metaDescription: Programmatically focus any registered input field, with an option to also select its current value in React Hook Form.
sidebar: apiLinks
---
