...
## `setFocus:` <TypeText>[UseFormSetFocus](/ts#UseFormSetFocus)</TypeText>
...
| `options` | `shouldSelect` | <TypeText>boolean</TypeText> | <Since version="7.27.0" /> Whether to select the input content on focus. |
