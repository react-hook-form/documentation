...
## \</> `getFieldState:` <TypeText>[UseFormGetFieldState](/ts#UseFormGetFieldState)</TypeText> <Since version="7.25.0" />
...
| isValidating | <TypeText>`boolean`</TypeText>                 | <Since version="7.51.0" /> field is currently being validated.<br/>**Condition:** subscribe to `isValidating`. |
