---
title: getFieldState
description: Get validation and interaction state of a specific field.
metaDescription: Get the current validation and interaction state of a specific field — invalid, isDirty, isTouched, and error — from React Hook Form.
sidebar: apiLinks
---
