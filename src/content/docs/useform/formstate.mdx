---
title: formState
description: Access real-time form state properties.
metaDescription: Access real-time form state including isDirty, isValid, errors, isSubmitting, touchedFields, and dirtyFields from React Hook Form.
sidebar: apiLinks
---
