...
| `formState`  | `defaultValues`      | <TypeText>object</TypeText>               | The value that was set in [`useForm`](/docs/useform)'s `defaultValues` or updated `defaultValues` via [`reset`](/docs/useform/reset) API.                                                                                                                                                                                            |
