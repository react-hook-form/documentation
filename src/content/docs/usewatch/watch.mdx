---
title: Watch
description: React component that subscribes to form input changes.
metaDescription: A React component that subscribes to form input changes and re-renders only its children, scoping updates for better performance.
sidebar: apiLinks
---
