...
Testing is very important because it prevents bugs and mistakes in your code. It also guarantees code safety when refactoring the codebase.
...
We have set the role attribute accordingly. These attributes are helpful when you write tests, and they improve accessibility. For more information, you can refer to the [testing-library](https://testing-library.com/) documentation.
