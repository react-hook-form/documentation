...
export default {
  ...
  v6: {
    articles: [
      ...
      {
        url:
          "https://medium.com/@angular_evan/yup-you-should-use-react-hook-form-9864d8bc80ef",
      ...
      {
        url:
          "https://medium.com/better-programming/build-the-next-generation-of-forms-with-react-hooks-forms-b4f2039e51c1",
      ...
      {
        url:
          "https://velog.io/@iamchanii/react-hooks-form-%EC%9D%84-%EC%86%8C%EA%B0%9C%ED%95%A9%EB%8B%88%EB%8B%A4-54k0rrj6m7",
      ...
      {
        url:
          "https://dev.to/bluebill1049/form-validation-with-hook-in-3kb-3d0l",
      ...
      {
        url:
          "https://dev.to/aaronksaunders/using-react-hook-form-with-ionic-react-components-2aab",
    ...
    videos: [
      ...
      },
      {
        ...
        description: (
          <p>
            I feel like forms in react can get quite complicated. React hook
            form makes it slightly easier. This is a tutorial on how and why to
            use react hook form.
          </p>
        ),
      },
      ...
      },
      {
        ...
        description: (
          <p>
            Learn about how to make forms with flexible sections, and also to
            use Module Federation to load in those form sections via dependency
            injection.
          </p>
        ),
      },
      ...
      },
      {
        ...
        description: (
          <p>
            ...
            React, building out form state, validation, errors, and more? Worry
            no more! With React Hook Form, create forms in a matter of minutes!
            It'll be the easiest, fastest way you've ever built a form in React!
            Replace your old, boring
          </p>
        ),
      },
      {
      ...
      },
      {
        ...
        description: (
          <p>
            Let's learn how to create a custom input for react-hook-form. We
            will use a simple login form as an example React application.
          </p>
        ),
      },
      {
        ...
        description: (
          <p>
            React-hook-form supports file uploads. In this video I'll show you
            how to upload files using react-hook-form. And also we'll update the
      ...
      },
      {
        ...
        description: (
          <p>
            Using React Hook Form with Ionic Framework React Components - this
            is based on the blog post
          </p>
        ),
      },
      {
