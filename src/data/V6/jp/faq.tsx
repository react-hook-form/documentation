...
export default {
  ...
  questions: [
    ...
    //       <p>
    //         <code>useForm</code>{" "}
    //         が取得されている間、非同期送信関数を実行します。
    //         をアンマウントすると、React at から次のような警告が表示されます。
    //         <b>dev build</b>。
    //       </p>
    //       <blockquote>
    //         マウントされていないコンポーネントでReactの状態更新を実行できません。
    //       </blockquote>
    //       <p>
    //         これは、prodビルドでは同じケースではありませんが、そのような動作をするように作られています。
    //         はReactの高速リフレッシュに対応しています。入力の<code>ref</code> の
    //         コールバックは高速リフレッシュ中には再実行されないので dev only
    //         でフックのアンマウントチェックを無効にしました。
    //       </p>
    //     </>
    //   ),
    // },
