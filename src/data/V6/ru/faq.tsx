...
import focusController from "../../../components/V6/codeExamples/focusController"
import toggleFields from "../../../components/V6/codeExamples/toggleFields"
...
export default {
  ...
  questions: [
    ...
    // {
    //   title: "Предупреждение о немонтируемых компонентах?",
    //   description: (
    //     <>
    //       <p>
    //         Выполните асинхронную функцию отправки, пока <code>useForm</code> не
    //         получит не смонтированный приведет к следующему предупреждению от
    //         React at ".
    //         <b>dev build</b>.
    //       </p>
    //
    //       <blockquote>
    //         Не может выполнить обновление состояния "Реакция" на немонтируемом
    //         компоненте.
    //       </blockquote>
    //
    //       <p>
    //         Это не то же самое, что и при сборке уколов, такое поведение
    //         делается так, что мы... совместимы с быстрым освежением React.
    //         Входы' <code>обновление</code> ". обратный вызов не будет выполнен
    //         снова во время быстрого обновления, так что у нас есть отключил
    //         проверку разматывания крюка только у Дэва.
    //       </p>
    //     </>
    //   ),
    // },
