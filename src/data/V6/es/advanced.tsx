...
import accessibleCodeBase from "../../../components/V6/codeExamples/accessibleCodeBase"
import accessibleCodeFinal from "../../../components/V6/codeExamples/accessibleCodeFinal"
import {
  step1,
  step2,
  step3,
} from "../../../components/V6/codeExamples/formWizard"
import * as CodeExampleTestingForm from "../../../components/V6/codeExamples/testingForm"
import smartForm from "../../../components/V6/codeExamples/smartForm"
import form from "../../../components/V6/codeExamples/form"
import input from "../../../components/V6/codeExamples/input"
import { Link as PageLink } from "gatsby"
import typographyStyles from "../../../styles/typography.module.css"
import buttonStyles from "../../../styles/button.module.css"
import customHookWithValidationResolver from "../../../components/V6/codeExamples/customHookWithValidationResolver"
import virtualizedList from "../../../components/V6/codeExamples/virtualizedList"
import strictlyTyped from "../../../components/V6/codeExamples/strictlyTyped"
...
export default {
  ...
  transformAndParse: {
    title: "Transformar y analizar",
    description: (
      <>
        <p>
          El valor de retorno de la entrada nativa está normalmente en{" "}
          <code>string</code> formato a menos que se invoque con{" "}
          <code>valueAsNumber</code> o <code>valueAsDate</code>, puede leer más
          en{" "}
          <a
            target="_blank"
            rel="noopener noreferrer"
          ...
          . Sin embargo, no es perfecto, todavía tenemos que lidiar con...
          <code>isNaN</code> o <code>null</code> valor. Así que es mejor dejar
          la transformación a nivel de componente. En el siguiente ejemplo,
          estamos usando el <code>Controller</code> para incluir la
          funcionalidad de transforman la entrada y la salida del valor. También
          puede lograr similares con el resultado personalizado{" "}
          <code>register</code>.
        </p>
      </>
    ),
