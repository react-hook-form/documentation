    ...
    pt: [
      {
        ...
        description: (
          <p>
            Performance é um dos objetivos principais, para construir esse hook customizável. 
            React Hook Form depende de componentes incontroláveis, consequentemente
            a razão da função de 'register' ocorre com o uso do ref. Esta abordagem
            irá reduzir o total de re-renderização ocorridas pela escrita do usuário
            ou mudança de valores. Componentes montados na página são mais rápidos
            porque eles não são controlados. Para montar com velocidade, Eu tenho um 
            guia completo de comparações rápidas, que você pode conferir em{" "}
            <a
              href="https://github.com/bluebill1049/react-hook-form-performance-compare"
              target="_blank"
              rel="noopener noreferrer"
      ...
      },
      {
        ...
        description: (
          <p>
            ...
            , que nos possibilita construir formulários acessíveis e customizados facilmente.
          </p>
        ),
      },
      {
        ...
        description: (
          <>
            <p>
              Não, não nesta abordagem. mas você pode criar um embrulho por volta e usar como componente de classe.
            </p>

            <blockquote>
              Você nao pode utilizar o Hooks dentro de um componente de classe, mas você pode
              definir uma classe mista e funções de componente com Hooks em uma única árvore. 
              Se um componente é uma classe ou função que use o Hooks, é um detalhe de implementação
              do componente. A longo prazo esperamos que o Hooks seja a forma principal de escrever
          ...
          <>
            ...
            <ul>
              <li>
                <b>HTMLFormElement.reset()</b>
                <p>
                  Este método faz a mesma coisa que clicar no botão reset do formulário, e apenas limpa
              ...
              <li>
                ...
                <p>
                  React Hook Form's <code>reset</code> método irá limpar todos os valores do formulário,
                  e também irá limpar todos os <code>errors</code>{" "}
      ...
      },
      {
        ...
        description: (
          <p>
            O formulário React Hook depende de um componente não controlado. 
            Com um componente não controlado, você pode especificar um <code>defaultValue</code>{" "}
            ou <code>defaultChecked</code> para um campo individual. Entretanto, o
            hook mesmo provê uma forma simples de inicializar todos os valores dos campos também. 
      ...
      },
      {
        ...
        description: (
          <p>
            React Hook Form precisa do <code>ref</code> para coletar o valor do campo,
            entretanto, você pode querer usar o <code>ref</code> para outros propósitos
            (ex. rolar dentro de uma página). O seguinte exemplo irá mostrar como.
          </p>
        ),
      },
      {
        ...
        description: (
          <>
            <p>
              ...
              <code>ref</code>. De fato, você pode manualmente usar <code>setValue</code>,{" "}
              <code>setError</code> e <code>triggerValidation</code>.
            </p>

            <p>
              <Note>Nota:</Note> caso <code>ref</code> não tem sido registrado, React Hook Form não será capaz
              de registrar eventos do campo. Isso significa que você terá que manualmente atualizar 
              e setar os erros.
            </p>
          </>
        ),
      },
      {
        ...
        description: (
          <>
            ...
            <p>
              Para suporte legado ao IE11, Você pode importar a versão react-hook-form IE 11.
            </p>
          </>
        ),
      },
      {
        ...
        description: (
          <>
            ...
            <p>
              React Hook Form é construido com base em componentes não controlados, que significa
              que você não pode alterar o campo <code>value</code> através do{" "}
              <code>state</code> por <code>onChange</code>. Consequentemente você não precisa{" "}
        ...
        description: (
          <>
            <p>
              ...
              que está tornando a experiência de criação de formulários fácil e ótima. 
              No entanto, existem algumas diferenças fundamentais entre os três, 
              o formulário react-hook-hook é construído com a entrada descontrolada 
              em mente e tenta fornecer ao seu formulário o melhor desempenho e a 
              ...
              significa que não há nenhum componente para você importar. 
              Aqui estão algumas das diferenças de detalhes:
            </p>
              ...
              <Table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      renderize novamente de acordo com as mudanças de estado local, 
                      o que significa que você digita a entrada.
                    </td>
                    <td>
                    renderize novamente de acordo com as alterações da biblioteca 
                    de gerenciamento de estado (Redux), quando você digita em um campo.
                    </td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>Comunidade Média: Bem mantida a biblioteca pela comunidade</td>
                    <td>Comunidade Grande: Bem mantida a biblioteca pela comunidade</td>
                  </tr>
                </tbody>
              </Table>
            </TableWrapper>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>
              React-hook-form não é recmoendado para construçãoo de formulário controlado,
              entretantoo você pode utilizar facilmente.
            </p>
            <p>
              O truque utilizando <code>watch</code> API para monitoroar cada input e mudar 
              o valor assinado a prop
            </p>
            <p>
