  ...
  register: {
    ...
    description: (
      <>
        ...
        <p>If you are working with typescript and wish to define the type of register then you can define it as <code>register: UseFormRegister<FieldValues></code></p>
