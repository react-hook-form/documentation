      ...
      <ActionButtonGroup>
        ...
        >
          <svg viewBox="0 0 100 110">
            <path
              ...
              d="M39.6,47.6V73.4L61.7,60.5Zm2,3.5,16.2,9.4L41.6,69.9Z"
            />
            <path
              data-name="Compound Path"
              d="M88.1,33.3H11.9V87.7H88.1Zm-2,52.4H13.9V35.3H86.1Z"
            />
            <rect data-name="Path" x="20.3" y="22.8" width="59.3" height="2" />
            <rect data-name="Path" x="28.8" y="12.3" width="42.5" height="2" />
          </svg>
        ...
        >
          <svg viewBox="0 0 110 110">
            <ellipse
              ...
              ry="36.215"
            />
            <path d="M93.917,88.73L73.172,67.985c-1.432-1.432-3.754-1.432-5.186,0c-1.433,1.433-1.433,3.755,0,5.187L88.73,93.917     c1.432,1.432,3.754,1.432,5.187,0C95.35,92.484,95.35,90.163,93.917,88.73z" />
          </svg>
          <span>Advanced</span>
        </Button>
        ...
        >
          <svg viewBox="0 0 100 100">
            <path d="M98.5,61.4c0,8.1-5,15.3-12.4,18.3v7.6c0,1-0.6,1.8-1.5,2.2c-0.3,0.1-0.6,0.2-0.9,0.2c-0.6,0-1.2-0.2-1.7-0.7l-7.9-7.9H62.4  c-7.5,0-14.2-4.1-17.6-10.8c-0.4-0.7-0.1-1.6,0.7-2c0.7-0.4,1.6-0.1,2,0.7c2.9,5.7,8.6,9.2,14.9,9.2h12.3c0.4,0,0.8,0.2,1.1,0.4  l7.3,7.3v-7.2c0-0.6,0.4-1.2,1-1.4c6.8-2.3,11.4-8.6,11.4-15.8c0-8-5.7-14.9-13.6-16.4c-0.8-0.2-1.4-0.9-1.2-1.7  c0.2-0.8,0.9-1.4,1.7-1.2C91.8,43.8,98.5,51.9,98.5,61.4z M1.5,35.7c0-14,11.4-25.4,25.4-25.4h21.7c14,0,25.4,11.4,25.4,25.4  c0,14-11.4,25.4-25.4,25.4H32.9L22.4,71.6c-0.5,0.5-1.2,0.8-1.9,0.8c-1.5,0-2.7-1.2-2.7-2.7V59.4C8,55.6,1.5,46.3,1.5,35.7z   M4.5,35.7c0,9.6,6.2,18.2,15.3,21.2c0.6,0.2,1,0.8,1,1.4V69l10.4-10.4c0.3-0.3,0.7-0.4,1.1-0.4h16.2c12.3,0,22.4-10,22.4-22.4  c0-12.3-10-22.4-22.4-22.4H26.8C14.5,13.3,4.5,23.3,4.5,35.7z M36.6,46.3c-0.3,0.3-0.4,0.7-0.4,1.1s0.2,0.8,0.4,1.1  c0.3,0.3,0.7,0.4,1.1,0.4c0.4,0,0.8-0.2,1.1-0.4c0.3-0.3,0.4-0.7,0.4-1.1c0-0.4-0.2-0.8-0.4-1.1C38.2,45.8,37.2,45.8,36.6,46.3z   M32.4,30.8c0.8,0,1.5-0.7,1.5-1.5c0-1.2,0.5-2.2,1.4-3c0.9-0.7,2.1-1,3.2-0.8c1.4,0.3,2.6,1.5,2.9,2.9c0.3,1.5-0.2,2.9-1.4,3.8  c-2.4,1.9-3.8,4.6-3.8,7.5c0,0.8,0.7,1.5,1.5,1.5s1.5-0.7,1.5-1.5c0-1.9,1-3.8,2.7-5.2c2.1-1.6,3-4.2,2.5-6.8  c-0.5-2.6-2.6-4.7-5.2-5.2c-2.1-0.4-4.1,0.1-5.7,1.4c-1.6,1.3-2.5,3.2-2.5,5.3C30.9,30.1,31.5,30.8,32.4,30.8z" />
          </svg>
          <span>FAQs</span>
        </Button>
      </ActionButtonGroup>
